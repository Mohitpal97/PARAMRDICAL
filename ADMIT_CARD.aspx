<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ADMIT_CARD.aspx.cs" Inherits="PARAMEDICAL.ADMIT_CARD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server"  >    <div class="container">
            <div class="row">
                <div class="col-md-12 inner">                    
                    <div><h4 style="background:#67c9e0; text-align:center ;padding:2px 2px; COLOR:#FFFFFF" runat="server" id="lblAdmitCardDownLoad" >Admit Card DownLoad</h4> </div> 	
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-7">                                                     
							...
							<div class="col-md-8">
								<asp:TextBox runat="server" ID="txtRegistrationNo" maxlength="20" class="form-control" placeholder="Registration No" style="text-transform:uppercase;" ></asp:TextBox>
	...
	<option value="2020">2020</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">                            
                            ...
                            <div class="col-md-8">
                                <asp:DropDownList runat="server" ID="ddlCourse"  class="form-control selected-item select2me" type="list" placeholder="Course" > </asp:DropDownList>
	...
	<option value="c00007">POST DIPLOMA IN PATIENT CARE MANAGEMENT</option>
                    ...
                    <div class="row ">
                        <div class="col-md-3"></div>                        
                        <div class="col-md-7">                            
                            <label class="col-md-4 control-label" runat="server" id="SemesterOrYear">Semester/Year<span class="required"> *</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="col-md-6">   
                            <div class="form-actions fluid">
						        <div class="col-md-offset-3 col-md-9">
                                 ...
                                 <asp:Button runat="server" ID="btncancel" class="btn red" Text="Cancel" onclick="btncancel_Click"  />
